...
const Cart = () => {
    const {products,currency,cartItems,removeFromCart,updateCartItem,getCartCount,getCartAmount,navigate,axios,setCartItems,user}=useAppContext();
        ...
        <div className="flex flex-col md:flex-row mt-16">
            <div className='flex-1 max-w-4xl'>
                <h1 className="text-3xl font-medium mb-6">
                    Shopping Cart <span className="text-sm md:text-2xl text-primary">{getCartCount()}{' '}Items</span>
                </h1>
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                ...
                <div className="mb-6">
                    ...
                    <div className="relative flex justify-between items-start mt-2">
                        ...
                        <button onClick={() =>{ setShowAddress(!showAddress),navigate('/add-address')} } className="text-primary hover:underline cursor-pointer">
                            Change
                        </button>
                        {showAddress && (
