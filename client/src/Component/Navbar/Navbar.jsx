...
const Navbar = () => {
  ...
  return (
      ...
      >
        ...
        {/* Mobile Menu */}
        <div
          className={`fixed  top-0 left-0 w-full h-screen bg-white z-[999] flex flex-col md:hidden items-center justify-center gap-6 font-medium text-gray-800 transition-all duration-500 ${
